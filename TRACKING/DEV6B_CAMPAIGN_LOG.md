...
| 2026-09-07 | `v2_polyester_test` | `v2_original_5s_run2_final.mp4` | F09 preview v2.2.0 | `polyester` (Polyester) | 120 FPS / 1920×1080 (5 s) | 30 FPS / 720p, 1.0 Mo | OK | Mesures : chroma +18%, lum +14%, netteté +395% vs source (chroma mesuré max−min, indépendant de la luminosité) | Périmètre polyester (visuel uniquement, zéro audio/beats) : preset `polyester` (sharpen 2.6, glow 0.55/65, exp 0.25, sat 1.18, vib 15, warmth 1.04, vign 35). Positionné entre Clean CC (naturel) et TikTok 4K (agressif). Sortie : `output/v2_polyester_test.mp4` |
